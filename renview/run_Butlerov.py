...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    default_kwargs = {
        'species_file': r'./data/example_Butlerov/species_comp.out',
        'reactions_file': r'./data/example_Butlerov/reaction_rates.txt',
        'initial_reactant': 'R0',
        'reaction_cutoffrate': 1.0E-30,
        'elements_desired': ['C', 'H', 'O'],
        'normalization': 3,
        'output_directory': r'./results/example_Butlerov/',
        'generate_pathways': False,
        'pathway_file': r'./data/example_Butlerov/pathways.txt',
        'image_directory': r'./data/example_Butlerov/Images/',
        }
    run(**default_kwargs)
