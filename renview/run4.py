...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    default_kwargs = {
        'species_file': r'./data/example_vadhana/species_solution_10_opposite.out',
        'reactions_file': r'./data/example_vadhana/reaction_rates_solution_10_opposite.out',
        'initial_reactant': '(0)(000000)',
        'reaction_cutoffrate': 1.0E-09,
        'elements_desired': ['C', 'O'],
        'normalization': 2,
        'output_directory': r'./results/example_vadhana/',
        'generate_pathways': True,
        'pathway_file': r'./data/example_vadhana/paths_opposite_orientation.txt',
        'image_directory': r'./data/example_vadhana/Images/',
        }
    run(**default_kwargs)
